...
The following is a set of guidelines for contributing to the hl7-at-* projects and its packages,
...
- For reporting bugs the TC FHIR created an issue template for github, it can be found in each respective repository. For example in the FHIR CORE R4 it looks like this: [here](https://github.com/HL7Austria/HL7-AT-FHIR-Core-R4/blob/main/.github/ISSUE_TEMPLATE/hl7-at--bug-report.md) and is available automatically if a new issue is created. Feel free to copy this template for other repositories in the HL7Austria domain.
...
## Support
We actively monitor the issues coming in through the various GitHub repositories. You are welcome to register your bugs and feature suggestions there. For questions and broader discussions, we use the TC-Austria channel on [Zulip](https://chat.fhir.org).
